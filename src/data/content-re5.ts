...
export const RE5_COURSE: Course = {
  ...
  units: [
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "The FSCA guarantees products but not advice",
                "FAIS regulates the conduct of advisors and intermediaries, not the performance or merits of products",
                "Only the Prudential Authority can guarantee products",
                "FAIS only applies to insurance, not investments",
              ],
              correct: 1,
              feedback: {
                correct:
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "Nothing until the FSP has had 30 days to respond",
                "Suspend or withdraw the licence immediately where delay would prejudice clients, giving the FSP a chance to make representations afterwards",
                "Only refer the matter to the FAIS Ombud",
                "Automatically debar all the FSP's representatives with no process",
              ],
              correct: 1,
              feedback: {
                correct:
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "No - they may never render advice until fully fit & proper",
                "Yes - but only under supervision, subject to the FSCA's supervision requirements and the DOFA-based timelines to complete competency",
                "Yes - with no restrictions, because the FSP is licensed",
                "Only if the client signs a waiver",
              ],
              correct: 1,
              feedback: {
                correct:
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                ...
                "No - debarment requires a fair process: notice, reasons, and a chance for the representative to respond before the FSP proceeds",
                "Yes - as long as the FSCA is informed within a year",
                "Only if the representative has already resigned",
              ],
              correct: 1,
              feedback: {
                correct:
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "Yes - all training counts as CPD",
                "No - product-specific training and class-of-business training are separate competency requirements and do not count as CPD hours",
                "Yes - but only half the hours count",
                "Only if the insurer is also an FSP",
              ],
              correct: 1,
              feedback: {
                correct:
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "None - commission is confidential",
                "The duty to disclose the provider's remuneration/commission and manage conflicts of interest",
                "Only the record-keeping requirement",
                "The financial soundness requirement",
              ],
              correct: 1,
              feedback: {
                correct:
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "Refuse to help the client under any circumstances",
                "Proceed but record that the transaction is against the provider's recommendation, with the client's instruction and the warnings given",
                "Change the client's risk profile to match the product",
                "Ignore the mismatch since the client chose it",
              ],
              correct: 1,
              feedback: {
                correct:
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                "Keeping a written COI management policy",
                "Disclosing commission to the client",
                "Paying a representative a financial interest for giving preference to the quantity of business over its quality",
          ...
          steps: [
            {
              ...
              content:
              "<p>The <strong>FAIS Ombud</strong> resolves complaints by clients against FSPs/representatives fairly, economically and expeditiously. The Ombud can investigate, mediate and make a <strong>determination</strong> that has the effect of a court order.</p><p>The Ombud's monetary jurisdiction is limited: it may award compensation up to <strong>R800 000</strong> for a single complaint (a complainant may abandon the amount above this to stay within jurisdiction).</p>",
            },
            {
              type: "info",
            ...
            },
            {
              ...
              prompt:
              "The FAIS Ombud may award compensation for a single complaint up to a maximum of R___ .",
              correct: 800000,
              explanation:
              "The Ombud's monetary jurisdiction cap for a single complaint is R800 000.",
              feedback: {
                correct: "Correct - R800 000.",
                incorrect:
                "The Ombud's cap for a single complaint is R800 000; amounts above may be abandoned to stay in jurisdiction.",
              },
            },
            {
              type: "scenario",
              ...
              options: [
                "They must wait a full year before doing anything",
                "Because the FSP's six weeks to resolve has passed unresolved, the client may refer the complaint to the FAIS Ombud (within six months)",
                "They must approach the High Court first",
                "They have lost the right to complain",
              ],
              correct: 1,
              feedback: {
                correct:
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                ...
                "File a suspicious transaction report (STR) with the FIC and not tip off the client",
                "Do nothing unless the police ask",
                "Only report it to the FSCA",
              ],
              correct: 1,
              feedback: {
                correct:
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: ["An intermediary service", "Advice", "Neither - replacement is exempt", "Only advice if the client agrees"],
              correct: 1,
              feedback: {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                ...
                "Verbal only, to avoid a paper trail",
                "Provided only after the sale is concluded",
                "Limited to the product's benefits",
              ],
              correct: 0,
              feedback: {
          ...
          steps: [
            {
              ...
              options: ["R100 000", "R400 000", "R800 000", "Unlimited"],
              correct: 2,
              feedback: {
                correct: "R800 000 is the cap for a single complaint.",
                incorrect: "The cap is R800 000 for a single complaint.",
              },
            },
            {
              type: "mcq",
            ...
            },
            {
              ...
              options: [
                "Tip off the client as a courtesy",
                "File a suspicious transaction report with the FIC and not tip off the client",
                "Wait for the FSCA to investigate",
                "Immediately terminate the client with no report",
              ],
              correct: 1,
              feedback: {
            ...
            },
            {
              ...
              options: [
                "Be appointed by a different FSP immediately",
                "Not be appointed as a representative by any FSP while the debarment stands",
                "Continue rendering services under supervision",
                "Appoint themselves as a key individual",
              ],
              correct: 1,
              feedback: {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      title: "Mock Exam A",
      description:
      "A full 50-question mock at (or above) real RE5 difficulty. Give yourself 2 hours, no notes. Pass mark: 65% (33/50).",
      lessons: [
        {
          id: "re5-mock-a",
          title: "Mock Exam A - 50 Questions",
          steps: [
            { type: "info", title: "Exam Conditions", content: "<p><strong>50 questions · 2 hours · pass mark 65% (33 correct).</strong></p><p>No notes, no breaks. Read every option - several questions use 'EXCEPT', 'NOT', and precise time periods/amounts, exactly like the real exam. Mark your score at the end: 33+ is a pass.</p>" },
            { type: "mcq", question: "Q1. The primary purpose of the FAIS Act is to:", options: ["Guarantee returns on financial products", "Regulate the rendering of financial advice and intermediary services", "Set the repo rate", "License banks only"], correct: 1, feedback: { correct: "FAIS regulates advice and intermediary services.", incorrect: "FAIS regulates the rendering of advice and intermediary services." } },
            ...
            { type: "mcq", question: "Q3. Submitting a client's application form to an insurer is best classified as:", options: ["Advice", "An intermediary service", "A conflict of interest", "A prohibited act"], correct: 1, feedback: { correct: "It's an intermediary service.", incorrect: "Acting to conclude/maintain a product (not a recommendation) is an intermediary service." } },
            ...
            { type: "mcq", question: "Q8. Before suspending a licence, the FSCA must normally:", options: ["Do nothing", "Give notice and a chance to make representations (unless delay would prejudice clients/public)", "Get court approval", "Refer to the Ombud"], correct: 1, feedback: { correct: "Notice and representations, unless urgent client risk.", incorrect: "Normally notice + representations, unless a delay would prejudice clients/public." } },
            ...
            { type: "mcq", question: "Q10. A new representative who has not yet passed RE5 may render advice:", options: ["Never", "Only under supervision within the DOFA timelines", "Freely, since the FSP is licensed", "Only for investments"], correct: 1, feedback: { correct: "Under supervision within the DOFA-based timelines.", incorrect: "They may act under supervision while completing competency within DOFA timelines." } },
            { type: "mcq", question: "Q11. Debarment of a representative requires:", options: ["No process", "A fair process: notice, reasons and an opportunity to respond", "Only the Ombud's approval", "A criminal conviction in every case"], correct: 1, feedback: { correct: "A procedurally fair process is required.", incorrect: "Notice, reasons and an opportunity to be heard are required." } },
            { type: "mcq", question: "Q12. A debarred person may be appointed by another FSP:", options: ["Immediately", "After 30 days", "Not while the debarment stands", "If they pass RE5 again"], correct: 2, feedback: { correct: "Not while debarred.", incorrect: "No FSP may appoint them while the debarment stands." } },
            ...
            { type: "mcq", question: "Q16. The overarching duty in the General Code is to act:", options: ["In the FSP's own interest first", "Honestly, fairly, with due skill, care and diligence, in clients' interests", "To maximise commission", "Only within office hours"], correct: 1, feedback: { correct: "Honestly, fairly, with due skill, care and diligence.", incorrect: "The duty is honesty, fairness, due skill/care/diligence, in clients' interests." } },
            { type: "mcq", question: "Q17. Disclosure to a client must be all of these EXCEPT:", options: ["Factually correct", "Clear and not misleading", "Provided timeously", "Always maximally favourable to the product"], correct: 3, feedback: { correct: "It must be balanced, not spun favourably.", incorrect: "Disclosure must be balanced - not framed to always flatter the product." } },
            { type: "mcq", question: "Q18. Which must be disclosed to the client about the provider?", options: ["The provider's tax returns", "Licence category and whether they act under supervision", "The provider's personal salary", "The FSP's profit margin"], correct: 1, feedback: { correct: "Licence category and supervision status.", incorrect: "The provider must disclose licence category and supervision status, among other details." } },
            { type: "mcq", question: "Q19. A representative earns 5% commission but does not tell the client. This breaches the duty to:", options: ["Keep records", "Disclose remuneration and manage conflicts of interest", "Be financially sound", "Advertise fairly"], correct: 1, feedback: { correct: "Remuneration must be disclosed; the conflict managed.", incorrect: "Commission/remuneration must be disclosed and the conflict managed." } },
            { type: "mcq", question: "Q20. An oral disclosure of key information must be confirmed in writing:", options: ["Never", "Within a reasonable time", "Only if the client asks", "After 5 years"], correct: 1, feedback: { correct: "Within a reasonable time.", incorrect: "Oral disclosures of key info must be confirmed in writing within a reasonable time." } },
            { type: "mcq", question: "Q21. Before giving advice, a provider must conduct a:", options: ["Credit check only", "Needs analysis and suitability analysis", "Marketing survey", "Tax audit"], correct: 1, feedback: { correct: "A needs and suitability analysis.", incorrect: "A needs analysis and suitability analysis are required before advice." } },
            { type: "mcq", question: "Q22. If a client acts against the provider's recommendation, the provider should:", options: ["Refuse all service", "Record the instruction, the mismatch, and that risks were disclosed", "Change the client's risk profile", "Cancel the client's other policies"], correct: 1, feedback: { correct: "Record the against-advice instruction and warnings.", incorrect: "Record the client's instruction against advice and that risks were disclosed." } },
            { type: "mcq", question: "Q23. A record of advice must reflect:", options: ["Only the commission earned", "The needs considered, options considered, and basis for the recommendation", "The client's ID number only", "Nothing in writing"], correct: 1, feedback: { correct: "Needs, options and basis for the recommendation.", incorrect: "It must reflect needs, options considered and the basis for the recommendation." } },
            { type: "mcq", question: "Q24. General record retention under the Code is:", options: ["1 year", "3 years", "5 years", "Forever"], correct: 2, feedback: { correct: "Five years.", incorrect: "Five years is the standard." } },
            { type: "mcq", question: "Q25. A COI management policy must provide for the FSP to:", options: ["Increase commissions", "Identify, avoid/mitigate and disclose conflicts", "Conceal conflicts", "Reward volume over quality"], correct: 1, feedback: { correct: "Identify, avoid/mitigate and disclose.", incorrect: "It must identify, avoid/mitigate and disclose conflicts." } },
            { type: "mcq", question: "Q26. Which is expressly restricted by COI rules?", options: ["Disclosing commission", "Paying a financial interest that rewards quantity of business over quality", "Doing a needs analysis", "Keeping records"], correct: 1, feedback: { correct: "Rewarding quantity over quality is restricted.", incorrect: "Paying a financial interest for volume over quality is restricted." } },
            { type: "mcq", question: "Q27. Advertising by a provider must:", options: ["Create urgency at any cost", "Not be misleading and include required cautionary information", "Omit risks", "Promise returns"], correct: 1, feedback: { correct: "Not misleading, with required cautions.", incorrect: "Advertising must not mislead and must carry required cautions." } },
            { type: "mcq", question: "Q28. Which is a TCF outcome?", options: ["Products perform as customers were led to expect", "The FSP maximises profit", "Commission is hidden", "Clients cannot complain"], correct: 0, feedback: { correct: "Outcome 5 - products perform as led to expect.", incorrect: "One TCF outcome is that products perform as customers were led to expect." } },
            { type: "mcq", question: "Q29. TCF Outcome 6 concerns:", options: ["Higher fees", "No unreasonable post-sale barriers to switch, claim or complain", "Faster sales", "Bigger commissions"], correct: 1, feedback: { correct: "Removing unreasonable post-sale barriers.", incorrect: "Outcome 6 targets unreasonable post-sale barriers." } },
            ...
            { type: "mcq", question: "Q31. The FAIS Ombud's maximum single-complaint award is:", options: ["R80 000", "R400 000", "R800 000", "R8 million"], correct: 2, feedback: { correct: "R800 000.", incorrect: "The cap is R800 000." } },
            ...
            { type: "mcq", question: "Q35. An Ombud determination has the effect of:", options: ["A friendly suggestion", "A court order", "A press release", "A disclaimer"], correct: 1, feedback: { correct: "It has the effect of a court order.", incorrect: "A determination has the effect of a court order." } },
            { type: "mcq", question: "Q36. Under FICA, on suspecting money laundering a representative must:", options: ["Tip off the client", "File an STR with the FIC and not tip off the client", "Ignore it", "Report only to the FSCA"], correct: 1, feedback: { correct: "File an STR; don't tip off.", incorrect: "File an STR with the FIC and don't tip off the client." } },
            { type: "mcq", question: "Q37. 'Tipping off' a client about a suspicious transaction report is:", options: ["Encouraged", "Optional", "An offence under FICA", "Required by the Code"], correct: 2, feedback: { correct: "It is an offence.", incorrect: "Tipping off is an offence under FICA." } },
            ...
            { type: "mcq", question: "Q40. Customer due diligence (CDD) primarily involves:", options: ["Guaranteeing returns", "Identifying and verifying the client (and beneficial owner)", "Setting the client's fees", "Advertising to the client"], correct: 1, feedback: { correct: "Identify and verify the client/beneficial owner.", incorrect: "CDD is identifying and verifying the client and beneficial owner." } },
            ...
            { type: "scenario", question: "Q42. A client's risk profile is conservative, but they insist on a speculative product after warnings. Correct action:", options: ["Refuse entirely", "Proceed and record the against-advice instruction and warnings", "Falsify the risk profile", "Report the client to the FSCA"], correct: 1, feedback: { correct: "Record the against-advice instruction and warnings.", incorrect: "Record the instruction against advice and that risks were disclosed." } },
            ...
            { type: "scenario", question: "Q44. A colleague suggests splitting a client's cash deposit to stay under the FICA cash-reporting threshold. This is:", options: ["Smart admin", "Structuring - an attempt to evade reporting, which is unlawful", "Required by the Code", "A conflict of interest only"], correct: 1, feedback: { correct: "It's unlawful structuring to evade reporting.", incorrect: "Deliberately splitting to avoid the threshold is structuring - unlawful." } },
            { type: "mcq", question: "Q45. A licence LAPSES when, for example, the FSP:", options: ["Earns a profit", "Is finally liquidated or (for a natural person) dies", "Hires a new representative", "Advertises"], correct: 1, feedback: { correct: "Liquidation/death causes lapsing.", incorrect: "A licence lapses on final liquidation/deregistration or death." } },
            ...
            { type: "mcq", question: "Q47. Which best describes 'financial soundness' as a fit & proper requirement?", options: ["The client must be wealthy", "The FSP/representative must not be insolvent/under certain financial disabilities", "Returns must be guaranteed", "Commission must be high"], correct: 1, feedback: { correct: "Not insolvent / free of certain financial disabilities.", incorrect: "Financial soundness concerns solvency and the absence of certain financial disabilities." } },
            ...
            { type: "scenario", question: "Q49. A client complains in writing; you resolve it fully within 3 weeks to their satisfaction. Must you tell them about the Ombud?", options: ["Yes, always, even if resolved", "No - the Ombud referral right arises when the complaint is not resolved to their satisfaction", "Only if the loss exceeded R800 000", "Only after 6 weeks regardless"], correct: 1, feedback: { correct: "The Ombud referral is for unresolved/unsatisfactory outcomes.", incorrect: "You must inform them of the Ombud right when the complaint is not resolved to their satisfaction." } },
            ...
            { type: "info", title: "Score Yourself", content: "<p>Count your correct answers. <strong>33 or more (65%) is a pass.</strong></p><p>Under 33? Note which knowledge areas tripped you up and redo those teaching units, then attempt Mock Exam B. Aim to consistently score 40+ before booking the real exam.</p>" },
          ],
        },
      ],
    },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      title: "Mock Exam B",
      description:
      "A second full 50-question mock, harder distractors and more scenarios. 2 hours, no notes. Pass mark: 65% (33/50).",
      lessons: [
        {
          id: "re5-mock-b",
          title: "Mock Exam B - 50 Questions",
          steps: [
            { type: "info", title: "Exam Conditions", content: "<p><strong>50 questions · 2 hours · pass mark 65% (33 correct).</strong></p><p>This paper leans harder on scenarios and 'EXCEPT/NOT' framing. Don't peek at feedback until you've committed to an answer.</p>" },
            { type: "scenario", question: "Q1. A friend asks you, over coffee and without any client relationship, whether Fund X is 'a good buy'. You say 'yes, definitely put your money there.' Does FAIS apply?", options: ["No - it was casual", "Yes - a recommendation of a financial nature about a product is advice regardless of setting", "No - only written advice counts", "Only if they invest"], correct: 1, feedback: { correct: "A recommendation about a product is advice, setting aside.", incorrect: "A recommendation of a financial nature is advice regardless of the informal setting." } },
            { type: "mcq", question: "Q2. Which is an intermediary service, not advice?", options: ["Recommending a switch", "Collecting premiums on the insurer's behalf", "Proposing extra cover", "Guiding on cancellation"], correct: 1, feedback: { correct: "Collecting premiums is an intermediary service.", incorrect: "Handling premiums for the supplier is an intermediary service, not advice." } },
            ...
            { type: "mcq", question: "Q4. A Category IV FSP conducts:", options: ["Discretionary management", "Assistance business", "Hedge funds", "Administration"], correct: 1, feedback: { correct: "Category IV is assistance business.", incorrect: "Category IV = assistance business FSP." } },
            ...
            { type: "mcq", question: "Q7. Competence is measured from the:", options: ["Client's birthday", "Date of First Appointment (DOFA)", "Tax year-end", "Date the licence was issued to the FSP"], correct: 1, feedback: { correct: "From DOFA.", incorrect: "Competence timelines run from DOFA." } },
            { type: "mcq", question: "Q8. A representative authorised for several complex subclasses will require CPD hours of approximately:", options: ["0", "6", "Up to 18", "100"], correct: 2, feedback: { correct: "Up to 18 hours for more/complex classes.", incorrect: "More/complex authorisations require up to 18 CPD hours." } },
            { type: "mcq", question: "Q9. Class-of-business training must be completed:", options: ["Only after 5 years", "Before rendering advice in that class of business", "Never", "Only for Category II"], correct: 1, feedback: { correct: "Before advising in that class of business.", incorrect: "It must be done before rendering advice in that class of business." } },
            ...
            { type: "scenario", question: "Q11. A KI discovers a representative lied about their qualifications on appointment. The most appropriate response is to:", options: ["Ignore it if sales are good", "Investigate; the representative may no longer be fit & proper and a fair debarment process may follow", "Immediately jail the representative", "Increase their commission"], correct: 1, feedback: { correct: "Investigate; consider debarment via a fair process.", incorrect: "Dishonesty undermines fit & proper - investigate and follow a fair debarment process if warranted." } },
            { type: "mcq", question: "Q12. In a debarment, the representative is entitled to:", options: ["Nothing", "Notice, reasons and an opportunity to respond", "A guaranteed job elsewhere", "Automatic reinstatement"], correct: 1, feedback: { correct: "Notice, reasons, opportunity to respond.", incorrect: "They're entitled to notice, reasons and a chance to respond." } },
            ...
            { type: "mcq", question: "Q14. Disclosure that is technically true but leaves a misleading overall impression is:", options: ["Acceptable", "A breach - disclosure must not be misleading", "Only a problem in writing", "Fine if the client doesn't ask"], correct: 1, feedback: { correct: "Misleading-by-omission breaches the Code.", incorrect: "Even literally-true statements that mislead overall breach the Code." } },
            { type: "mcq", question: "Q15. Which must be disclosed about the PRODUCT?", options: ["The provider's home address", "Material terms, fees, charges, penalties and risks", "The FSP's staff count", "The Ombud's salary"], correct: 1, feedback: { correct: "Material terms, fees, charges, penalties, risks.", incorrect: "Product disclosure covers material terms, fees, charges, penalties and risks." } },
            { type: "mcq", question: "Q16. A fee negotiated directly with a client must be:", options: ["Kept secret", "Agreed in writing and stoppable by the client", "Non-refundable always", "Set by the FSCA"], correct: 1, feedback: { correct: "Agreed in writing; the client can stop it.", incorrect: "A negotiated fee must be agreed in writing and the client must be able to stop it." } },
            { type: "scenario", question: "Q17. A client refuses to share income and expense details but wants a full financial plan. You should:", options: ["Guess the figures", "Explain the limitation, record the refusal, and warn of resulting risks (limited-scope advice)", "Refuse and end the relationship", "Proceed as if you had full information"], correct: 1, feedback: { correct: "Record the refusal, give limited-scope advice with warnings.", incorrect: "Record the refusal and warn of the limitations/risks of limited-scope advice." } },
            { type: "mcq", question: "Q18. The record of advice must be:", options: ["Kept from the client", "Provided to the client and retained by the provider", "Verbal only", "Destroyed after the sale"], correct: 1, feedback: { correct: "Given to the client and retained.", incorrect: "It must be provided to the client and retained by the provider." } },
            { type: "mcq", question: "Q19. Replacement of one product with another triggers a duty to:", options: ["Hide the costs", "Compare and disclose the implications/costs of replacement to the client", "Always avoid replacement", "Charge a penalty"], correct: 1, feedback: { correct: "Disclose the implications and costs of replacing.", incorrect: "Replacement requires disclosing the costs/implications so the client can decide informed." } },
            ...
            { type: "scenario", question: "Q21. An insurer offers you a free overseas holiday if you sell 50 of its policies this quarter. Accepting this is:", options: ["Fine - it's a reward", "A prohibited financial interest rewarding volume over quality (a COI breach)", "Required by TCF", "Only an issue if disclosed"], correct: 1, feedback: { correct: "It rewards volume over quality - restricted.", incorrect: "Such incentives reward quantity over quality and fall foul of the COI rules." } },
            { type: "mcq", question: "Q22. A conflict of interest is:", options: ["Any client complaint", "A situation where the provider's interest may influence advice against the client's interest", "A licensing category", "A type of product"], correct: 1, feedback: { correct: "Interest that may sway advice against the client.", incorrect: "It's where the provider's own interest may bias advice against the client." } },
            ...
            { type: "mcq", question: "Q25. In direct marketing, at the START of contact the provider must disclose:", options: ["Their commission only", "Their identity, the purpose of the call and the client's rights", "Nothing", "The client's ID number"], correct: 1, feedback: { correct: "Identity, purpose and client's rights.", incorrect: "Disclose identity, purpose and the client's rights up front." } },
            { type: "mcq", question: "Q26. The FAIS Ombud resolves complaints:", options: ["Only in court", "Fairly, economically and expeditiously", "By arbitration abroad", "Only above R800 000"], correct: 1, feedback: { correct: "Fairly, economically and expeditiously.", incorrect: "The Ombud acts fairly, economically and expeditiously." } },
            { type: "scenario", question: "Q27. A client's loss is R1.2m from poor advice. The Ombud can still hear it if the client:", options: ["Does nothing", "Abandons the amount above R800 000 to fall within jurisdiction", "Sues the FSCA", "Waits three years"], correct: 1, feedback: { correct: "Abandon the excess above R800 000.", incorrect: "The client may abandon the amount over R800 000 to stay within the Ombud's jurisdiction." } },
            ...
            { type: "mcq", question: "Q30. Complaints procedures must be:", options: ["Secret", "Documented and accessible to clients", "Verbal only", "Optional"], correct: 1, feedback: { correct: "Documented and accessible.", incorrect: "They must be documented and accessible to clients." } },
            { type: "mcq", question: "Q31. Under FICA, an FSP that is an accountable institution must NOT:", options: ["Verify client identity", "Keep an RMCP", "Tip off a client about an STR", "Train staff"], correct: 2, feedback: { correct: "Tipping off is prohibited.", incorrect: "Tipping off about an STR is prohibited." } },
            ...
            { type: "mcq", question: "Q33. Beneficial ownership must be established as part of:", options: ["Advertising", "Customer due diligence", "CPD", "Record destruction"], correct: 1, feedback: { correct: "Part of CDD.", incorrect: "Identifying beneficial owners is part of CDD." } },
            { type: "mcq", question: "Q34. If a client refuses to provide FICA identification, the FSP should:", options: ["Proceed anyway", "Not establish/continue the business relationship (subject to the RMCP)", "Report to the Ombud", "Increase fees"], correct: 1, feedback: { correct: "CDD must be completed; otherwise don't proceed.", incorrect: "Without required CDD info, the relationship should not be established/continued." } },
            { type: "mcq", question: "Q35. The pass mark for the RE5 exam is:", options: ["50%", "60%", "65%", "75%"], correct: 2, feedback: { correct: "65%.", incorrect: "The RE5 pass mark is 65%." } },
            ...
            { type: "scenario", question: "Q37. You are unsure whether a proposed transaction suits the client. Best practice is to:", options: ["Proceed and hope", "Gather more information and only recommend if suitable, else decline/refer", "Recommend the highest-commission option", "Ask another client"], correct: 1, feedback: { correct: "Only recommend if suitable; otherwise decline/refer.", incorrect: "Suitability first - recommend only if suitable, else decline or refer." } },
            { type: "scenario", question: "Q38. A client wants to complain but doesn't know how. You must:", options: ["Discourage them", "Tell them the internal complaints process and, if unresolved, their Ombud rights", "Refer them to a competitor", "Charge a complaint fee"], correct: 1, feedback: { correct: "Explain the process and Ombud rights.", incorrect: "Inform them of the complaints process and Ombud rights." } },
            { type: "mcq", question: "Q39. A representative under supervision must:", options: ["Work entirely alone", "Be supervised in line with the FSCA supervision requirements", "Never contact clients", "Hold a Category II licence"], correct: 1, feedback: { correct: "Supervised per FSCA supervision requirements.", incorrect: "They must be supervised in line with the supervision requirements." } },
            { type: "mcq", question: "Q40. Which statement about commission is TRUE?", options: ["It need never be disclosed", "It must be disclosed to the client", "It is illegal", "Only fees, not commission, are disclosed"], correct: 1, feedback: { correct: "Commission must be disclosed.", incorrect: "Commission must be disclosed to the client." } },
            { type: "scenario", question: "Q41. You notice your FSP has no conflict-of-interest policy. This means the FSP is:", options: ["Compliant", "In breach - a COI management policy is mandatory", "Exempt if small", "Only at risk if a client complains"], correct: 1, feedback: { correct: "A COI policy is mandatory.", incorrect: "Every FSP must have a COI management policy - its absence is a breach." } },
            ...
            { type: "mcq", question: "Q43. Which is the correct order a dissatisfied client generally follows?", options: ["Ombud → FSP → court", "FSP internal complaint → FAIS Ombud", "Court → Ombud → FSP", "FSCA → FSP → Ombud"], correct: 1, feedback: { correct: "FSP first, then the Ombud.", incorrect: "Complain to the FSP first, then the Ombud if unresolved." } },
            ...
            { type: "scenario", question: "Q45. A client signs a form you haven't completed, trusting you to 'fill it in later'. You should:", options: ["Fill it in however suits you", "Not accept blank signed forms; complete and confirm details with the client", "Backdate it", "Sign on the client's behalf"], correct: 1, feedback: { correct: "Don't use blank signed forms; complete and confirm with the client.", incorrect: "Blank signed forms are a serious conduct risk - complete and confirm with the client." } },
            { type: "mcq", question: "Q46. A determination amount unpaid by an FSP can be:", options: ["Ignored", "Enforced as if it were a court order", "Waived by the representative", "Only collected by SARS"], correct: 1, feedback: { correct: "Enforced like a court order.", incorrect: "A determination is enforceable as a court order." } },
            { type: "mcq", question: "Q47. The main aim of TCF is to:", options: ["Increase FSP profits", "Embed fair treatment of customers across the product life cycle", "Reduce disclosure", "Speed up sales"], correct: 1, feedback: { correct: "Fair treatment across the life cycle.", incorrect: "TCF embeds fair customer treatment throughout the product life cycle." } },
            { type: "mcq", question: "Q48. Which is required BEFORE a product-specific recommendation?", options: ["Nothing", "Product-specific training on that product", "A 5-year wait", "A court order"], correct: 1, feedback: { correct: "Product-specific training is required first.", incorrect: "You need product-specific training before advising on that product." } },
            ...
            { type: "mcq", question: "Q50. Overall, the RE5 tests a representative's knowledge of:", options: ["Product pricing formulas", "The FAIS regulatory framework and their conduct obligations", "Marketing techniques", "Accounting standards"], correct: 1, feedback: { correct: "The FAIS framework and conduct obligations.", incorrect: "RE5 tests the FAIS regulatory framework and your conduct obligations." } },
            { type: "info", title: "Score Yourself", content: "<p><strong>33+ = pass (65%).</strong> Compare with your Mock Exam A score.</p><p>Consistently 40+ across both mocks, with no single knowledge area repeatedly weak, is a strong signal you're ready. Book the real exam with confidence - and re-verify the current format on the FSCA site first.</p>" },
          ],
        },
      ],
    },
