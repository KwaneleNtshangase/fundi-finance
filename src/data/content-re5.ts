      ...
      lessons: [
        {
          ...
          steps: [
            ...
            { type: "scenario", question: "Q27. A client's loss is R1.2m from poor advice. The Ombud can still hear it if the client:", options: ["First obtains condonation from the FSCA", "Abandons the portion above R800 000", "Files the claim against the FSCA instead", "Waits three years for the cap to lapse"], correct: 1, feedback: { correct: "Abandon the excess above R800 000.", incorrect: "The client may abandon the amount over R800 000 to stay within the Ombud's jurisdiction." } },
