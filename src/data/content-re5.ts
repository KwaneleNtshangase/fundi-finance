      ...
      lessons: [
        {
          ...
          steps: [
            ...
            { type: "scenario", question: "Q49. A client complains in writing; you resolve it fully within 3 weeks to their satisfaction. Must you tell them about the Ombud?", options: ["Yes, the Ombud must be disclosed in every case", "No, that right arises when it is not resolved satisfactorily", "Only where the claimed loss exceeded R800 000", "Only once six weeks have passed, regardless of outcome"], correct: 1, feedback: { correct: "The Ombud referral is for unresolved/unsatisfactory outcomes.", incorrect: "You must inform them of the Ombud right when the complaint is not resolved to their satisfaction." } },
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            { type: "mcq", question: "Q30. Complaints procedures must be:", options: ["Kept internal to protect the FSP's reputation", "Documented and accessible to clients", "Handled verbally to resolve matters faster", "Optional for FSPs with few clients"], correct: 1, feedback: { correct: "Documented and accessible.", incorrect: "They must be documented and accessible to clients." } },
