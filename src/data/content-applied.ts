...
export const LESSON_PERSONAL_LOAN_TRAP: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      feedback: {
        correct:
          "Correct — it is false. The NCA sets maximum interest rates. For personal/unsecured loans the cap is repo rate + 21% (currently around 29–30%). Lenders cannot legally exceed this. If a lender is charging more, walk away — it may be illegal.",
        incorrect:
...
export const LESSON_WHATSAPP_SCHEME: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      feedback: {
        correct:
          "Correct. The triple-red-flag combination: guaranteed returns (no investment guarantees returns — it is illegal to promise them), no risk (all real investments carry risk), and 15% monthly = 180% per year (the JSE averages ~10–12% per YEAR). This is a Ponzi scheme pattern: early investors are paid with money from new investors, not real returns.",
        incorrect:
          "Option B contains the clearest red flags. '15% monthly returns' = 180%/year (impossibly high). 'No risk, fully guaranteed' — illegal to promise in SA. These three promises together almost perfectly describe a Ponzi scheme. The WhatsApp channel and the friend's involvement are concerning but are not themselves proof of fraud.",
      },
    },
    {
      type: "fill-blank",
    ...
    },
    {
      ...
      feedback: {
        ...
        incorrect:
          "The answer is B. Ponzi schemes use new investor money to pay existing investors. The early payments are real — that is what makes them convincing. But the scheme is mathematically guaranteed to collapse when recruitment slows. Your friend's profits are funded by the next victim.",
      },
    },
    {
      type: "action-check",
...
export const LESSON_SUNK_COST_INVESTING: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      feedback: {
        correct:
          "Correct. The R45 original price is a sunk cost — it is gone and cannot be recovered. The only rational question is: given R4 400 TODAY, what is the best home for it going forward? What you paid in the past is irrelevant to what happens next. This is hard emotionally but it is the foundation of sound investing.",
        incorrect:
